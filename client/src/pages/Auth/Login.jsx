          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="hidden lg:block space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl font-bold tracking-tight text-gray-900">Welcome back</h1>
                <p className="text-xl text-gray-600">Sign in to continue tracking your academic performance.</p>
              </div>
            </div>
