...
const CGPACard = ({ cgpa = 0, lastUpdated, semesterData = [] }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-navy-800 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 p-8 border border-gray-100 dark:border-navy-700"
    >
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-lg font-semibold text-black dark:text-white">Current CGPA</h2>
        <div className="px-3 py-1 bg-gray-100 dark:bg-navy-700 rounded-full">
      ...
      {/* Chart */}
      <div className="mt-8 pt-6 border-t border-gray-100 dark:border-navy-700">
        <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Progress Trend</h3>
      ...
      {/* Stats Grid */}
      <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t border-gray-100 dark:border-navy-700">
        <div className="text-center">
          <p className="text-2xl font-bold text-black dark:text-white">
            {semesterData.length || 0}
          </p>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Semesters</p>
        </div>
        <div className="text-center">
          <p className="text-2xl font-bold text-black dark:text-white">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Courses</p>
        </div>
      </div>
    </motion.div>
  );
